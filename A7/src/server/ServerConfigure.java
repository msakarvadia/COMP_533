...
@Tags({DistributedTags.SERVER_CONFIGURER, DistributedTags.RMI, DistributedTags.GIPC, DistributedTags.NIO, DistributedTags.ATOMIC_BROADCAST, DistributedTags.TWO_PHASE_COMMIT})
